<?php 
   ...
   <!-- /mobile-menu-holder-->
   <header id="header-6" class="headerHolder header-3 header-6">
      <div class="nav-button-holder nav-button-holder-3 nav-button-holder-6">
         <?php if (has_nav_menu('primary-menu')) { ?>
      ...
      <?php 	$mt_logo_img = get_theme_mod( 'custom_logo' );
         ...
         ?>
      <div class="logo logo-6"><a href="<?php echo esc_url( home_url( '/' ) ); ?>"><img class="img-fluid" src="<?php echo esc_url($mt_logo_img_url[0]); ?>" width="<?php echo esc_attr($mt_logo_img_url[1]); ?>" height="<?php echo esc_attr($mt_logo_img_url[2]); ?>" alt="<?php bloginfo('name'); ?>" /></a></div>
      <?php else: ?>
      <div class="logo logo-6">
         <div class="logo-txt"><a href="<?php echo esc_url( home_url( '/' ) ); ?>"><?php bloginfo('name'); ?></a></div>
      </div>
      <?php endif; ?>
     <div class="social-btn-top6">
